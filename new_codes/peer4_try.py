...
def send_messages(client_socket, ready_signalb):
    ready_signalb.wait()
...
def receive_messages(receive_server_socket,ready_signala):
    ready_signala.set()
...
def main():
    ...
    send_thread = threading.Thread(target=send_messages, args=(send_socket,ready_signalb))
    receive_thread = threading.Thread(target=receive_messages, args=(receive_server_socket,ready_signala))
