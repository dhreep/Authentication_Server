...
def communication(HOSTL,PORTL):
    ...
    while True:
        ...
        if(choice==1 or f==1):  # server
            ...
            server_socket.bind((HOSTL, PORTL))
            server_socket.listen()

            print("Server is listening on {}:{}".format(HOSTL, PORTL))
            ...
            # Configuration - get it form database using server
            HOST = '10.0.2.15'
            PORT = 12349
